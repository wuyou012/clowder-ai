...
test('Windows installer runs preflight before Node and pnpm bootstrap', () => {
  ...
  const nodeStepIndex = installScript.indexOf('Write-Step "Step 2/7 - Node.js and pnpm"');
  const wingetIndex = installScript.indexOf('winget install -e --id OpenJS.NodeJS.LTS --version 24.');
