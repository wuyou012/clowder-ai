# Review Request: F219 Phase 1 — Prompt Injection Visibility
...
- 来源：`docs/features/F219-prompt-injection-visibility.md` (Why section) + Issue #839
...
```
pnpm test           → 2 failures (pre-existing: signal-fetcher-launchd.sh missing, 非 F219)
...
- Spec: `docs/features/F219-prompt-injection-visibility.md`
- Issue: https://github.com/zts212653/clowder-ai/issues/839
- Feature: F219 / Phase 1
